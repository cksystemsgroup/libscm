/*
 * Copyright (c) 2010-2013, the project authors. All rights reserved.
 * Please see the AUTHORS file for details. Use of this source code
 * is governed by a license that can be found in the LICENSE file.
 *
 * Computational Systems Group, cs.uni-salzburg.at/~ck/group
