...
/*
 * Expires an object descriptor and decrements its descriptor counter. When the
 * descriptor counter is 0, the object to which the descriptor points to is deallocated.
 * Returns 0 iff no more expired object descriptors exist.
 */
 ...
 * expire_buffer operates always on the current_index-1 list of the buffer
 */
...
/**
 * Increments the current index modulo the maximal expiration extension.
 */
