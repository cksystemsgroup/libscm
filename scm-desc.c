...
//thread-local storage: descriptor_root
...
/**
 * Allocates memory with ptmalloc2 and wraps object
 * header around requested memory.
 */
void *__wrap_malloc(size_t size) {
...
/**
 * Reallocates memory with ptmalloc2 and wraps object
 * header around requested memory.
 */
void *__wrap_realloc(void *ptr, size_t size) {
...
/**
 * Dellocates memory if object descriptor
 * counter is 0.
 */
void __wrap_free(void *ptr) {
